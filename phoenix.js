...
var setupHandlers = function(useSizeUpDefaults){
    ...
    return {
        ...
        thirds: [
            ...
            new Key('4',     modKeys1, putWindow('upThird')),
            new Key('5',     modKeys1, putWindow('vcenterThird')),
            new Key('6',     modKeys1, putWindow('downThird')),
        ...
        sixths: [
            new Key('7', modKeys1, putWindow('topLeftSix')),
            new Key('8', modKeys1, putWindow('topCentreSix')),
            new Key('9', modKeys1, putWindow('topRightSix')),
            new Key('7', modKeys2, putWindow('botLeftSix')),
            new Key('8', modKeys2, putWindow('botCentreSix')),
            new Key('9', modKeys2, putWindow('botRightSix')),
        ],
...
var getSubFrame = function(parentFrame, direction) {
    ...
    **/
    ...
    var subFrames = {
        ...
        upThird:      { x: x(),                 y: y(),                 width: parentWidth,    height: parentThirdHigh },
        down:         { x: x(),                 y: y(parentHalfHigh),   width: parentWidth,    height: parentHalfHigh },
        downThird:    { x: x(),                 y: y(parentTwoThirdsHigh),   width: parentWidth,    height: parentThirdHigh },
        ...
        vcenterThird: { x: x(),                 y: y(parentThirdHigh),   width: parentWidth,    height: parentThirdHigh },
